...
// Home, Direct, Explore, Heart, Profile, 
export function Home({ label = '홈' }) {
    return (
...
export function Direct({ label = 'Direct' }) {
    return (
        <div className={styles.Icon}>
            <svg
                aria-label={label}
...
export function Explore({ label = '탐색' }) {
    return (
        <div className={styles.Icon}>
            <svg
                aria-label={label}
...
export function Heart({ label = 'Heart' }) {
    return (
        <div className={styles.Icon}>
            <svg
                aria-label={label}
...
export function Profile({ label = '프로필' }) {
    return (
        <div className={styles.Icon}>
            <svg
                aria-label={label}
...
export function Bookmark({ label = '저장됨' }) {
    return (
        <div className={styles.Icon}>
            <svg
                aria-label={label}
...
export function Setting({ label = '설정' }) {
    return (
        <div className={styles.Icon}>
            <svg
                aria-label={label}
...
export function Change({ label = '계정 전환' }) {
    return (
        <div className={styles.Icon}>
            <svg
                aria-label={label}
